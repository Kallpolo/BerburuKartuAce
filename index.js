...
function gameOver()
{
    ...
    const gameOverMessage = `Permainan telah berakhir! Skormu = <span class = 'badge'>${score}</span> Klik 'Play Game' untuk memainkan permainan lagi`
...
function chooseCard(card)
{
    if(canChooseCard())
    {
        ...
        setTimeout(() => {
            flipCards(false)
            updateStatusElement(currentGameStatusElem,"block", primaryColor,"Posisi Kartu Terlihat")
...
function outputChoiceFeedBack(hit)
{
    if(hit)
    {
        updateStatusElement(currentGameStatusElem, "block", winColor, "(Alok) Kerja Bagus!! :)")
    }
    else
    {
        updateStatusElement(currentGameStatusElem, "block", loseColor, "Coba lagi!! :(")
    }
}
...
function checkForIncompleteGame()
{
    ...
    if(serializedGameObj)
    {
        ...
        {
            if(confirm('Apakah Anda ingin melanjutkan permainan terakhir anda?'))
            {
                score = gameObj.score
...
function initializeNewRound()
{
    ...
    updateStatusElement(currentGameStatusElem, "block", primaryColor, "Tunggu! Sedang diacak...")
...
function shuffleCards()
{
    ...
    function shuffle()
    {
        ...
        if(shuffleCount == 500)
        {
            ...
            dealCards()
            updateStatusElement(currentGameStatusElem, "block", primaryColor, "Silahkan pilih kartu yang menurut anda adalah kartu Ace ...")
